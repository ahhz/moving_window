...
#include <moving_window/dereference_proxy.h>
...
namespace moving_window {
    ...
    std::ptrdiff_t>
  {
    ...
    typedef dereference_proxy<this_type, raster_value_type> dereference_proxy;
  ...
  private:
    ...
    dereference_proxy dereference() const
    {
      return dereference_proxy(this);
    }
  ...
  public:
    ...
    typedef dereference_proxy<this_type, value_type> dereference_proxy;
  ...
  private:
    ...
    friend class boost::iterator_core_access;
    friend struct dereference_proxy;
