...
#ifndef MOVING_WINDOW_VIEW_H_AHZ
#define MOVING_WINDOW_VIEW_H_AHZ

#include <moving_window/traits.h>
#include <moving_window/moving_window_patch_view_helper.h>
#include <moving_window/window.h>
#include <moving_window/non_square_window_edge_iterator.h>
#include <moving_window/non_square_window_iterator.h>
#include <moving_window/square_window_edge_iterator.h>
...
namespace moving_window {
  ...
  struct moving_window_pixel_view
  {
    ...
    using raster_value_type = typename raster_traits::value_type<raster_type>::type;
  ...
  {
    using index_map_type = gdal_raster<int>;
    using element_type = typename indicator_traits<IndicatorTag>::element_type_tag;
    ...
    {
      m_index_raster = create_temp_gdal_raster<int>(
