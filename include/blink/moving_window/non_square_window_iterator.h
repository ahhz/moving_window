...
#ifndef BLINK_MOVING_WINDOW_NON_SQUARE_WINDOW_ITERATOR_H_AHZ
#define BLINK_MOVING_WINDOW_NON_SQUARE_WINDOW_ITERATOR_H_AHZ
...
namespace blink {
  namespace moving_window {
    ...
    private:
      ...
      typedef blink::raster::raster_view <
